...
<script type="text/javascript" src="{{asset('assets/assets/js/sweetalert2.all.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/assets/js/swal.js')}}"></script>
